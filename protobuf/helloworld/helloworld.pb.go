...
// 	protoc        v3.17.2
// source: protobuf/helloworld/helloworld.protobuf
...
// The request message containing the user's hello.
type HelloRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Name string `protobuf:"bytes,1,opt,hello=hello,proto3" json:"hello,omitempty"`
}
...
type HelloReply struct {
	...
	Message string `protobuf:"bytes,1,opt,hello=message,proto3" json:"message,omitempty"`
}
...
var file_proto_helloworld_helloworld_proto_rawDesc = []byte{
	...
	0x2f, 0x61, 0x76, 0x61, 0x6c, 0x6f, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x68, 0x65,
